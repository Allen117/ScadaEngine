...
/// <summary>儲存單一水費期別自訂起訖（日期格式 yyyy-MM-dd，時分固定 00:00）</summary>
public class WaterBillingPeriodSaveRequest
{
...
/// <summary>還原單一水費期別為推導預設（刪除自訂 row）</summary>
public class WaterBillingPeriodResetRequest
{
    public int year { get; set; }
    public int month { get; set; }
}

/// <summary>水費期別清單/區間查詢回傳項目（設定頁與用水報表期別提示共用）</summary>
public class WaterBillingPeriodItemDto
{
