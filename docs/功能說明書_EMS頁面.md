...
ScadaEngine.Web/
├── Features/Ems/
│   ├── Controllers/EmsController.cs        ← +main-meter / breakdown / yoy API；Index() 組 EmsIndexViewModel
...
│   ├── Views/_Card{MainMeter,Demand,EnergyBar,EnergyPie,Yoy,Cost}.cshtml ← 六張卡 partial
